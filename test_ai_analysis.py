#!/usr/bin/env python3
"""
Test script to verify AI analysis is working and producing detailed logs
"""
import asyncio
import websockets
import json
...
async def test_ai_analysis():
    ...
    try:
        ...
        async with websockets.connect(uri) as websocket:
            ...
            # Start the bot (which should auto-start AI analysis)
            ...
            while time.time() - start_time < 120:  # Wait up to 2 minutes
                try:
                    ...
                    if data['type'] == 'analysis_log':
                        print(f"📝 Analysis Log: {data['data']['message']}")
